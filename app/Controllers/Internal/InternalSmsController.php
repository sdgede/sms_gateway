...
/**
 * Internal SMS Dispatcher API Controller
 * 
 * Used by backend applications and microservices to enqueue outbound SMS,
 * query real-time delivery status, and inspect system-wide queue metrics.
 * Protected by X-API-Key (internal_api_auth).
 */
class InternalSmsController extends BaseController
{
    ...
    /**
     * Dispatch / Queue a new SMS message from backend services
    ...
    public function send(): ResponseInterface
    {
        ...
        try {
            ...
            log_message('error', '[InternalSms::send] ' . $e->getMessage());
    ...
    /**
     * Get SMS Job status by internal job_id or client_message_id
    ...
    /**
     * Get Aggregate Outbound Statistics

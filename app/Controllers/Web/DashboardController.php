...
/**
 * Web Dashboard & Administrative Controller
 * 
 * Handles UI rendering, polling data, pairing code lifecycle,
 * manual SMS dispatch testing, device management, and worker maintenance.
 */

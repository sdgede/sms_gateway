...
/**
 * Dedicated Hardware & Custom Android Gateway Controller
 * 
 * Manages device pairing handshake, token security, device profile,
 * periodic device telemetry heartbeats, SSE event streaming,
 * job atomic locking/claiming, and operator delivery reports.
 */
class GatewayApiController extends BaseController
{
    ...
    /**
     * One-Time Device Pairing Handshake
     * POST /gateway/pair
     */
